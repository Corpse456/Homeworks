    ...
    public static void main(String[] args) {
        for (int i = 0; i < 9; i++) {
            ...
            if (i == 0) {
                ...
                if (i != 8) {
                    System.out.print("<td align=\"center\"><i><b>" + (8 - i) + "</b></i></td>");
                } else {
            ...
            for (int j = 1; j < 9; j++) {
                ...
                if (i == 0) {
                    if (j % 2 != 0) {
                        System.out.print("<td" + WIDTH + CELLSIZE + LIGHTCOLOR + "background=\"Images//"
                                         + BLACK[j] + ".png\"></td>");
                    } else {
                        System.out.print("<td" + WIDTH + CELLSIZE + DARKCOLOR + "background=\"Images//"
                                         + BLACK[j] + ".png\"></td>");
                    }
                    continue;
                }
                if (i == 1 || i == 6) {
                    if (i % 2 - j % 2 != 0) {
                        System.out.print("<td" + LIGHTCOLOR + "background=\"Images//" +
                                         (i == 1 ? BLACK[0] : WHITE[0]) + ".png\"></td>");
                    } else {
                        System.out.print("<td" + DARKCOLOR + "background=\"Images//" +
                                         (i == 1 ? BLACK[0] : WHITE[0]) + ".png\"></td>");
                    }
                    continue;
                }
                ...
                if (i % 2 - j % 2 != 0) {
                    System.out.print("<td" + LIGHTCOLOR + "></td>");
                } else {
                    System.out.print("<td" + DARKCOLOR + "></td>");
                }
            }
            System.out.print("</tr>");
        }
