...
public class HtmlPageCreator {
    ...
    public void saveAsHtmlPage(File f) {
        ...
        for (int i = 0; i < text.size(); i++) {
            if (i % 2 == 0) {
                html.writeLine("<b>" + text.get(i) + "</b><br/>");
            } else {
                html.writeLine("<i>" + text.get(i) + "</i><br/>");
            }
        }
    ...
    public static void main(String[] args) {
        ...
        text.add(
                "ДЗ1. Маленькое. Написать класс, объект которого хранит массив строк (или лист). И в нем должен быть объектный метод saveAsHtmlPage(File f). Этот метод должен сохранить все строки из листа в виде корректного HTML документа. Каждая строка (в объекте) с новой строки (в браузере) Строки должны чередоваться по принципу жирная-курсивная-жирная-курсивная.");
